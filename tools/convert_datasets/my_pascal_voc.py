...
# label_ids = {name: i + 1 for i, name in enumerate(mydata_classes())}
...
def main():
    #args = parse_args()
    devkit_path = '../../data/VOCdevkit/'#devkit_path = '../../data/VOCdevkit'#args.devkit_path
